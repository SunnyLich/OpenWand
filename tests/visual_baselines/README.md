...
These PNGs cover OpenWand's five critical desktop surfaces on Windows: onboarding,
...
```powershell
$env:OPENWAND_UPDATE_VISUAL_BASELINES = "1"
.\.venv\Scripts\python.exe -m pytest -q tests\test_visual_regression.py
Remove-Item Env:\OPENWAND_UPDATE_VISUAL_BASELINES
```
