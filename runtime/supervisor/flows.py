...
class FlowController:
    ...
    def begin_caller(self, caller_idx: int = 0) -> None:
        ...
        # A requested desktop capture must happen before the picker is visible,
        # otherwise Wisp itself becomes part of the image. Context capture does
        # not have that restriction: the picker is first shown without taking
        # focus, then activated after the original selection/focus is captured.
        screenshot_b64 = None
