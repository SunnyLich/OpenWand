"""Real Wisp model -> preview -> focusless VS Code live API smoke."""
...
def inner() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="wisp-vscode-cdp-flow-") as profile:
            ...
            result.update(
                {
                    ...
                    "preview_has_diff": bool(previews and "wisp_api_test" in str(previews[-1]["params"].get("html") or "")),
