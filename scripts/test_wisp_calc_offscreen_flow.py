"""Run Wisp's real intent-context flow against a live minimized Calc window."""
...
def main() -> int:
    ...
    if not context_updates:
        raise RuntimeError("Wisp did not publish intent context items.")
    ...
    print(
        json.dumps(
            {
                "flow": "Wisp FlowController.begin_caller",
