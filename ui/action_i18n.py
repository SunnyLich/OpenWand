...
ACTION_I18N_SOURCES: tuple[str, ...] = (
    ...
    "This Calc window was opened before Wisp's background action session. Save your work and restart LibreOffice once; Wisp will then create charts without taking focus.",
    ...
    "Wisp couldn't prepare the Calc chart preview: {error}",
    "Wisp couldn't create the chart: {error}",
    "Create chart in Calc",
    "CALC ACTION · PREVIEW",
    "Wisp will add this chart in the same open Calc window.",
    "Workbook",
    "Source",
    "Size",
    ...
    "Wisp could not find a numeric series in this selection. The final chart may be empty.",
    ...
    "Wisp couldn't prepare the Calc action preview: {error}",
    "Wisp couldn't apply the Calc action: {error}",
    ...
    "Wisp will improve the selected table's presentation without changing its contents.",
    "Cell contents",
    "Unchanged",
    ...
    "Sort rows in Calc",
    "Wisp will reorder complete rows; it will not sort one column independently.",
    "Sort by",
    "Direction",
    "Ascending",
    "Descending",
    ...
    "Review the exact workbook changes before Wisp applies them.",
    ...
    "Creating the table cannot yet be completely undone by Wisp.",
    "column",
    "line",
    "bar",
    "pie",
    ...
    "Save this tab once, then press Ctrl+Shift+Q again. Wisp did not change anything.",
    ...
    "Wisp couldn't prepare the VS Code action: {error}",
    "VS Code fix failed: {error}",
    "Wisp couldn't build a safe code diff: {error}",
    "Wisp couldn't apply the code change: {error}",
    "Apply code fix",
    "VS CODE ACTION - PREVIEW",
    "Review the exact saved-file change before Wisp applies it.",
    "File",
    "Selection",
    "Changed lines",
    ...
    "Wisp couldn't build a safe code diff for the Untitled tab.",
    "Safety checks passed. Building the exact Untitled editor diff preview...",
    "Apply code to Untitled tab",
    "Review the exact change before Wisp writes it into the captured Untitled editor.",
    "Tab",
    "Target",
    "Selected text",
    "Insertion point",
    "Apply writes only to the editor target captured when you opened Wisp.",
    ...
    "Wisp could not write to the captured Untitled editor target.",
    "The Untitled editor target changed before Apply, so Wisp did not paste the code.",
    ...
    "Wisp could not inspect this page through its private browser API. Reopen Chrome through Wisp control and try again.",
    ...
    "Wisp couldn't prepare this browser action: {error}",
    "Browser form action failed: {error}",
    "Wisp couldn't build a safe form preview: {error}",
    "Wisp couldn't fill the browser form: {error}",
    "Fill web form",
    "BROWSER ACTION - PREVIEW",
    "Review every value before Wisp fills the current page.",
    "Page",
    "Fields",
    "Submission",
    "Will not submit",
...
_DYNAMIC_PATTERNS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"Wisp couldn't prepare the Calc chart preview: (?P<error>.+)"), "Wisp couldn't prepare the Calc chart preview: {error}"),
    (re.compile(r"Wisp couldn't create the chart: (?P<error>.+)"), "Wisp couldn't create the chart: {error}"),
    (re.compile(r"Wisp couldn't prepare the Calc action preview: (?P<error>.+)"), "Wisp couldn't prepare the Calc action preview: {error}"),
    (re.compile(r"Wisp couldn't apply the Calc action: (?P<error>.+)"), "Wisp couldn't apply the Calc action: {error}"),
    (re.compile(r"Wisp couldn't prepare the VS Code action: (?P<error>.+)"), "Wisp couldn't prepare the VS Code action: {error}"),
    (re.compile(r"VS Code fix failed: (?P<error>.+)"), "VS Code fix failed: {error}"),
    (re.compile(r"Wisp couldn't build a safe code diff: (?P<error>.+)"), "Wisp couldn't build a safe code diff: {error}"),
    (re.compile(r"Wisp couldn't apply the code change: (?P<error>.+)"), "Wisp couldn't apply the code change: {error}"),
    ...
    (re.compile(r"Wisp couldn't prepare this browser action: (?P<error>.+)"), "Wisp couldn't prepare this browser action: {error}"),
    (re.compile(r"Browser form action failed: (?P<error>.+)"), "Browser form action failed: {error}"),
    (re.compile(r"Wisp couldn't build a safe form preview: (?P<error>.+)"), "Wisp couldn't build a safe form preview: {error}"),
    (re.compile(r"Wisp couldn't fill the browser form: (?P<error>.+)"), "Wisp couldn't fill the browser form: {error}"),
