...
# PyInstaller specification for the Windows OpenWand executable bundle.
...
a = Analysis(
    ...
    pathex=[str(ROOT)],
    binaries=QT_RUNTIME_DLLS + LITEPARSE_BINARIES + ANYDOC_BINARIES + LANGUAGE_TAGS_BINARIES + CLAUDE_SDK_BINARIES + ZIAMATH_BINARIES + LATEX2MATHML_BINARIES + UV_BINARIES,
    datas=[
