/* i18n.js — translation engine for the OpenWand docs.
...
function setLang(code) {
  ...
  I18N.cur = code;
  try { localStorage.setItem('openwand-lang', code); } catch (e) {}
...
function initI18n() {
  let saved = 'en';
  try { saved = localStorage.getItem('openwand-lang') || 'en'; } catch (e) {}
