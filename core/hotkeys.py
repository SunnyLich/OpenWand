...
Linux:   Uses pynput.keyboard.GlobalHotKeys in the native worker — does NOT
         consume the keystroke, but fires callbacks reliably on X11 without root.

Push-to-talk (press + release on a single key) uses pynput.keyboard.Listener
on Windows/Linux. macOS uses Carbon hotkey press/release events instead.
"""
...
# ---------------------------------------------------------------------------
# Linux/macOS fallback implementation — pynput GlobalHotKeys
# ---------------------------------------------------------------------------
