...
PROFILE_ID_KEY = "WISP_PROFILE_ID"
PROFILE_LABEL_KEY = "WISP_PROFILE_LABEL"

_LEGACY_PRESET_KEY = "WISP_SETTINGS_PRESET"
_LEGACY_PRESET_PREFIX = "WISP_PRESET_"
_PROFILE_META_KEYS = {
    "ACTIVE_PROFILE",
    "SETTINGS_PROFILE",
    "PROFILE_COUNT",
...
_SHARED_EXACT_KEYS = {
    "WISP_ONBOARDING_COMPLETE",
    "WISP_ONBOARDING_MODE",
    "START_ON_LOGIN",
    "APP_LANGUAGE",
    "GITHUB_CLIENT_ID",
    "GITHUB_OAUTH_SCOPES",
