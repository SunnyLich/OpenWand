...
def build_table_chart_plan(
    ...
    *,
    ...
    table_name = _available_name("OpenWandTable", snapshot.table_names)
    operations = [
        ActionOperation(
            id="create_table",
            type=CREATE_TABLE,
    ...
    if include_chart:
        operations.append(
            ActionOperation(
                ...
                args={
                    "source": table_name,
                    "name": _available_name("OpenWandChart", snapshot.chart_names),
                    "kind": chart_kind,
...
def valid_excel_object_name(name: str) -> bool:
    """Conservatively accept safe table/chart names generated by OpenWand."""
